// E:\PMP_new\pmp\front\src\pages\InfluencerPage\ui\InfluencerPage\InfluencerPage.tsx

// conitrue from here - update props - > so data from container should be taken
